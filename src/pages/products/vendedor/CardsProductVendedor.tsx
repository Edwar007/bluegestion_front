...
import ProducSelec from "./ProducSelecVendedor";
import SearchFilterCrearOrden from "./SearchFilterSelecProductVendedor";
...
const CardsProductVendedor: React.FC = () => {
...
export default CardsProductVendedor;
